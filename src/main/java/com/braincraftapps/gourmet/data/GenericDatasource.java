...
// Общий класс, который содержит общую функциональность для взаимодействия с базой данных.
// Конкретные объекты источника данных должны расширить этот класс и реализовать свои абстрактные методы.
public abstract class GenericDatasource<E> implements IDatasource<E>, IReadable {
    ...
    public List<E> findAll() {
        ...
        // Находит записи в базе данных, указав
        // имя таблицы и столбцы таблицы
